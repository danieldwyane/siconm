...
<?php include_once "assets/siconm/js/v_empresa.js"; ?>
</script>
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Administrador Empresas</li>
    </ol>
</section>
...
<section class="content">
   ...
   <div class="col-xs-12 text-right">
        <button type="button" id="btn_agregar_empresa" class="btn btn-azul-modal pull-right">Agregar Empresa</button>
   </div>
