...
<?php include_once "assets/rem/js/reportes/v_rpt_rem_ejec.js"; ?>
</script>
<!-- Content Header (Page header) -->
<section class="content-header">
    <h1>
        Listado Entrega De Efectivo Ejecutivo
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Supervisor Bóveda</li>
        <li class="active">Retirar Efectivo Ejec.</li>
    </ol>
</section>
