...
<!--        <script type="text/javascript" src="http://maps.google.com/maps/api/js?key=AIzaSyDXu6NShuYaryksdxc-RZshVrooiJgqjqE &sensor=false&language=es"></script>-->
        ...
        //CSS Vista
        echo css_asset('reporte/v_rpt_procura_bolip.css', 'empresa_distribucion');
...
//        echo js_asset('mapa_panaderia/v_registrar_panaderia.js', 'panaderia');
        echo js_asset('reporte/v_rpt_procura_bolip.js', 'empresa_distribucion');
        ?>
    ...
    <body>
        ...
        <div id="capa_formulario" class="container-fluid">
            ...
            <div class="col-xs-12">
                <h4 style="text-align: center">Seguimiento Procura</h4>
            </div>

            <div class="row">
                <div id="leyenda" class="col-md-4">
                    <fieldset>
                        <div class="row">
                            <legend class="text-left">Leyenda </legend>
                        </div>  
                        <div class="row">
                            <div id = "rojo" class="icono_ofic fa fa-square" ></div> Aguas Internacionales
                        </div>
                        <div class="row">
                            <div id = "naranja" class="icono_ofic_ext fa fa-square"></div> Buque Fondeado
                        </div>
                        <div class="row">
                            <div id = "amarillo" class="icono_ofic fa fa-square" ></div>  Buque Atracado
                        </div>
                        <div class="row">
                            <div id = "azul" class="icono_ofic_ext fa fa-square"></div> Incio de Operaciones
                        </div>
                        <div class="row">
                            <div id = "verde" class="icono_ofic_ext fa fa-square"></div> Fin de Operaciones
                        </div>
                    </fieldset>      
                </div>
            </div>
