...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo css_asset('reporte/v_rpt_empresas.css', 'empresa_distribucion');
        ...
        echo js_asset('reporte/v_rpt_empresas.js', 'empresa_distribucion');
        ?>
   ...
   <div id="tabla_reporte" class="container-fluid">
       ...
       <table id="tbl_reporte" class="display table table-striped table-bordered " cellspacing="0">
           <thead>
               <tr>
                   <!--<th colspan=""></th>-->
                   <th colspan="9" class="text-center">Datos de la Empresa</th>
                   <th colspan="5" class="text-center">Ubicación</th>
               </tr>
               <tr>
                   <th style="text-align: center">Rif</th>
                   <th style="text-align: center">Razon Social</th>
                   <th style="text-align: center">Responsable</th>
                   <th style="text-align: center">Tlf. Responsable</th>
                   <th style="text-align: center">Correo</th>
                   <th style="text-align: center">Propiedad</th>
                   <th style="text-align: center">Tipo</th>
                   <th style="text-align: center">Actividad</th>
                   <th style="text-align: center">Asociación</th>
