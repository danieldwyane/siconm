...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo css_asset('reporte/v_rpt_ventas.css', 'empresa_distribucion');
        ...
        echo js_asset('reporte/v_rpt_ventas.js', 'empresa_distribucion');
        ?>
       ...
       <table id="tbl_reporte" class="display table table-striped table-bordered " cellspacing="0">
           <thead>
               <tr>
                   ...
                   <th colspan="5" class="text-center">Datos de la Venta</th>
               </tr>
               <tr>
