...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo js_asset('reporte/v_derivados_producidos.js', 'empresa_distribucion');
        ?>
       ...
       <table id="tbl_reporte" class="display table table-striped table-bordered " cellspacing="0">
           <thead>
               <tr>
                   ...
                   <th colspan="1" class="text-center">Derivado</th>
                   ...
                   <th colspan="1" class="text-center">Fecha Producción</th>
               </tr>
