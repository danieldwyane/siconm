...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo css_asset('reporte/v_rpt_insumo_recepcionado.css', 'empresa_distribucion');
        ...
        echo js_asset('reporte/v_rpt_insumo_recepcionado.js', 'empresa_distribucion');
        ?>
