...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo js_asset('reporte/v_produccion_inventario.js', 'empresa_distribucion');
        ?>
       ...
       <table id="tbl_reporte" class="display table table-striped table-bordered " cellspacing="0">
           <thead>
               <tr>
                   ...
                   <th colspan="1" class="text-center">5ta Útl. Producción</th>
                   <th colspan="1" class="text-center">4ta Últ. Producción</th>
                   <th colspan="1" class="text-center">Antepenúltima Producción</th>
                   <th colspan="1" class="text-center">Penúltima Producción</th>
                   <th colspan="1" class="text-center">Última Producción</th>
                   <th colspan="1" class="text-center">Inventario</th>
               </tr>
