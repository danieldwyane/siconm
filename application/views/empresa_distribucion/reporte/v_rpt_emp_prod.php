...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo css_asset('reporte/v_rpt_emp_prod.css', 'empresa_distribucion');
        ...
        echo js_asset('reporte/v_rpt_emp_prod.js', 'empresa_distribucion');
        ?>
...
<!--                    <th style="text-align: center">Correo</th>-->
                    ...
                    <th style="text-align: center">Rif Empresa Receptora</th>
                    <th style="text-align: center">Producto</th>
                    <th style="text-align: center">Especificacion</th>
