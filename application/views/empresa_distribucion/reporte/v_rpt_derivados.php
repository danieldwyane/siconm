...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo css_asset('reporte/v_rpt_derivados.css', 'empresa_distribucion');
        ...
        echo js_asset('reporte/v_rpt_derivados.js', 'empresa_distribucion');
        ?>
        ...
        <table id="tbl_reporte" class="display table table-striped table-bordered " cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th colspan="2" class="text-center">Datos del Derivado</th>
                </tr>
                <tr>
                    <th style="text-align: center">Razon Social</th>
                    <th style="text-align: center">Rif</th>
                    <th style="text-align: center">Derivado</th>
