...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo css_asset('reporte/v_rpt_insumo_solicitado.css', 'empresa_distribucion');
        ...
        echo js_asset('reporte/v_rpt_insumo_solicitado.js', 'empresa_distribucion');
        ?>
       ...
       <table id="tbl_reporte" class="display table table-striped table-bordered " cellspacing="0">
           <thead>
               ...
               <tr>
                   ...
                   <th style="text-align: center">Inventario Minimo</th>
