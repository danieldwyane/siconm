...
<html lang="en">
	...
	echo css_asset('dataTables.bootstrap.min.css','DataTables-1.10.12/media');
        ...
        echo css_asset('reporte/v_rpt_inventario_pecuario.css', 'empresa_distribucion');
        ...
        echo js_asset('reporte/v_rpt_inventario_pecuario.js', 'empresa_distribucion');
        ?>
       ...
       <table id="tbl_reporte" class="display table table-striped table-bordered " cellspacing="0">
           <thead>
               <tr>
                   ...
                   <th colspan="4" class="text-center">Datos Agropecuarios</th>
               </tr>
               <tr>
                   ...
                   <th style="text-align: center">Rendimiento por Animal</th>
