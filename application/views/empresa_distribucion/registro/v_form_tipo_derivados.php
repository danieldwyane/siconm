            ...
            <div class="row row-centered">
                <div class="col-md-8 col-centered">
                    ...
                    <form id="form_registro" role="form" data-toggle="validator">
                        ...
                        <div class="col-md-12">
                            <legend>
                                <h3 class="text-primary text-center">Registro Tipo Derivados</h3>
                            </legend>
                        </div>
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input id="descripcion_derivados" name="descripcion_derivados" class="form-control" required>
                            <div class="help-block with-errors"></div> 
                        </div>
                        ...
                        <div class="col-md-12 form-group text-center">
                            <button type="button" id="btn_registro_tipo_derivados"class="btn btn-primary">Guardar</button>
                        </div>
