...
<?php include_once "assets/sidre/js/distribucion/v_form_carga_masiva.js"; ?>
</script>
...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Inicio Operativo</li>
    </ol>
</section>
...
<section class="content">
    ...
    <div class="col-sm-12 col-centered capa_iniciar_operativo1">
        <div class="col-xs-12 col-lg-12 text-right">
            <button type="button" class="btn btn-azul-modal" id="iniciar_operativo">Iniciar Operativo</button>
        </div>
    </div>

    <div class="box box-default capa_carga_masiva1">
